			...
			<div class="site-head">
				...
				<div class="site-header-nav">
					<div class="container" id="site-nav-container">
						...
						<div class="col-md-1" id="location-container">
							<button type="button" class="btn btn-toolbar" id="location"><span class="glyphicon glyphicon-map-marker"></span> 杭州</button>
						</div>
				...
				<div id="site-head-search" class="col-lg-6">
					...
					<div class="input-group ">
						<input type="text " class="form-control head-search" id="head-search-text" placeholder="请输入区域、商圈或小区名开始找房">
						<span class="input-group-btn ">
							<button class="btn btn-success head-search" type="button " id="head-search-btn">开始找房</button>
						</span>
					</div>
				</div>
			</div>
